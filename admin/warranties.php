...
<body>
    ...
    <main class="main-content">
        ...
        <div class="content-card shadow-sm border-0 rounded-4 p-4 bg-white">
            ...
            <?php endif; ?>
            <?php if (isset($error)): ?>
                <div class="alert alert-danger mb-4 border-0 rounded-3"><?php echo e($error); ?></div>
            <?php endif; ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="fw-bold fw-monospace text-primary">
                                <i class="bi bi-upc-scan me-1"></i> <?php echo e($w['imei']); ?>
                            </td>
                            <td><?php echo e($w['product_name']); ?></td>
                            <td>
                                <?php if($w['order_id']): ?>
                                    <a href="invoice.php?order_id=<?php echo e($w['order_id']); ?>" target="_blank" class="text-decoration-none">#ORD-<?php echo e($w['order_id']); ?></a>
                                <?php else: ?>
                            ...
                            <td>
                                ...
                                ?>
                                <span class="badge bg-<?php echo $badge; ?>-subtle text-dark border fw-normal px-2"><?php echo e($w['status']); ?></span>
                            </td>
                            <td class="text-end">
                                <a href="warranties.php?edit=<?php echo e($w['id']); ?>" class="btn btn-sm btn-light border p-2"><i class="bi bi-pencil text-primary"></i></a>
                                <a href="warranties.php?delete=<?php echo e($w['id']); ?>&csrf_token=<?php echo get_csrf_token(); ?>" class="btn btn-sm btn-light border p-2 text-danger ms-1" onclick="return confirm('Xóa trạm bảo hành IMEI này?')"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                ...
                <form action="warranties.php" method="POST">
                    ...
                    <div class="modal-body px-4 py-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="imei" class="form-control bg-light border-0" value="<?php echo e($editData['imei'] ?? ''); ?>" required placeholder="VD: 351234567890123">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="product_id" class="form-select bg-light border-0" required>
                                ...
                                <?php foreach($productsList as $p): ?>
                                    <option value="<?php echo e($p['id']); ?>" <?php echo (isset($editData['product_id']) && $editData['product_id'] == $p['id']) ? 'selected' : ''; ?>>
                                        <?php echo e($p['name']); ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="order_id" class="form-control bg-light border-0" value="<?php echo e($editData['order_id'] ?? ''); ?>" placeholder="Nhập ID đơn hàng (nếu bán qua hệ thống)">
                        </div>
